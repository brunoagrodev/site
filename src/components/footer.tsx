...
const Footer = () => {
  ...
  return (
    <div className="footer bg-white text-white py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="footer-down flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <div className="mt-6 md:mt-0">
            ...
            <ul className="mt-4 space-y-2 text-lg text-[#101b2b]">
              <li>Email: <a href="mailto:aprimoraconhecimento@gmail.com" className="text-[#101b2b] hover:underline">aprimoraconhecimento@gmail.com</a></li>
              <li>Telefone: <a href="https://wa.me/55849991557670?text=Ol%C3%A1%2C%20gostaria%20de%20entrar%20em%20contato%20com%20a%20Aprimora%20Conhecimento." className="text-[#101b2b] hover:underline">+55 84 99155-7670</a></li>
        ...
        <div className="footer-bottom text-center text-lg font-lustria text-[#101b2b]">
          <a href="/privacypolicy">
            <p>&copy; Copyright 2025 - Todos os direitos reservados - Aprimora Conhecimento</p>
          </a>
        </div>
      </div>
    </div>
